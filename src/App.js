...
import VoiceAgent from './components/VoiceAgent'; // 👈 this brings in the voice component
  ...
  return ( 
    <Router>
      <CartProvider>
        ...
        <VoiceAgent /> {/* 👈 Add the voice agent here so it appears in all pages */}
        <ScrollToTop />
        <Switch>
          <Route path="/registeration">
            <div className="register-style page-background">
              <Signup
